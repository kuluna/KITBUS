...
/**
 *  八束穂の今日の時刻表を表示するFragment
 */
class YatsukahoFragment() : TimetableFragment() {

    override var resId: Int = R.string.ogigaoka

    override val timetables: List<Timetable>
        get() = Gson().fromJson(Preference(context).timetableYatsukahoSerialize, object : TypeToken<List<Timetable>>() {}.type)
